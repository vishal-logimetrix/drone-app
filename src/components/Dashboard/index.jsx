      ...
      <div className="row">
        ...
        <ListGroup.Item style={{ padding: '0' }}>
          ...
          >
            ...
            >
              <span style={{fontSize: '18px', color: '#4083a9', fontWeight: 700 }}>0</span>
            ...
            >
              <span style={{ fontSize: '18px', color: '#4083a9', fontWeight: 700 }}>10</span>
        ...
        <ListGroup.Item
          style={{
           // backgroundColor: '#a5c4e4', // Adjusted background color based on the image
            textAlign: 'center',
            // padding: '20px 0', // Padding for better alignment
            color: '#d6c9e2',
            fontSize: '16px',
            height: '50px'
          }}
