    ...
    <div className={`${styles.sidebar} ${isCollapsed ? styles.collapsed : ""}`}>
      <ul className={styles.sidebarItems}>
        ...
        <li>
          ...
          <ul className={`${styles.subMenu} ${ openMenu === "master" ? styles.open : "" }`} >
            <li>
              <NavLink to="/manageUserRole"
                className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/manageProjects" className={({ isActive }) =>
                  isActive ? `${ styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/area" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/subarea" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/manageSnapBlock" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/uploadAPK" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
                <FaUpload className={styles.icon} />
            ...
            <li>
              <NavLink to="/uploadKMZ" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
                <FaUpload className={styles.icon} />
        ...
        <li>
          <div onClick={() => toggleMenu("settings")} className={styles.menuItem} >
            <div className={styles.menuItemContent}>
          ...
          <ul className={`${styles.subMenu} ${ openMenu === "settings" ? styles.open : "" }`} >
            <li>
              <NavLink to="/projectSites" className={({ isActive }) =>
                   isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/geomapping" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/dailyProjects" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/daywise" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/processedImages" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
            ...
            <li>
              <NavLink to="/userreport" className={({ isActive }) =>
                  isActive ? `${styles.subMenuLink} ${styles.activeLink}` : styles.subMenuLink } >
