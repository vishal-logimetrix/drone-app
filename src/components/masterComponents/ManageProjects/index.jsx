...
import styles from './managProjects.module.css';
...
const ManageProjects = () => {
  ...
  const roles = [
    { id: 1, projectName: 'MSEDCL2-Badisidd-300MW' },
    { id: 2, projectName: 'TEST-IT' },
    { id: 3, projectName: 'KREDL-Sidlaghatta-20MW' },
    { id: 4, projectName: 'KREDL-Sandur-20MW' },
    { id: 5, projectName: 'KREDL-Guledgudda-15MW' },
    { id: 6, projectName: 'MSEDCL-Chittorgarh-250MW' },
  ];

  const filteredRoles = roles.filter(role =>
    role.projectName.toLowerCase().includes(searchTerm.toLowerCase())
  );
